...
body {
   background-image: url("https://scontent-iad3-1.xx.fbcdn.net/v/t1.0-9/206357_490803417611555_328586716_n.jpg?_nc_cat=102&_nc_ht=scontent-iad3-1.xx&oh=72580425db4c021a78e96a7d5082fcd8&oe=5CA250BF");
   color: black;
font-weight: bold;
}
		.jumbotron{
...
<form method="post" action="account.php" > <!-- creates a form with this php file as the action to take -->

	<p>Username: <input type="text" name="user"></p>  <!-- sets name and password variables -->
	<p>Password: <input type="password" name="pass"></p> <!-- type="password" blocks out characters-->
<?php
...
$query1 = "select username from Users where username='$user' and password='$pass'";
