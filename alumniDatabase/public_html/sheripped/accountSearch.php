...
<form method="post" action="accountSearch.php"> <!-- creates a form with this php file as the action to take -->
...
<div class="col-sm">
   Select Attribute:&ensp;<select name="formtask1" class="form-control-sm" id="exampleFormControlSelect1">
...
<input type="name" class="form-control-sm">
<div class="col-sm">
    Display From: &emsp; <select name="formtask2" class="form-control-sm" id="exampleFormControlSelect1">
